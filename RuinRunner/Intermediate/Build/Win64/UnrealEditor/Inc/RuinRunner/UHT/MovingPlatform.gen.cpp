...
#include "RuinRunner/MovingPlatform.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMovingPlatform() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	RUINRUNNER_API UClass* Z_Construct_UClass_AMovingPlatform();
	RUINRUNNER_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
	UPackage* Z_Construct_UPackage__Script_RuinRunner();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMovingPlatform_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_RuinRunner,
	};
#if WITH_METADATA
	...
	template<> RUINRUNNER_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	AMovingPlatform::~AMovingPlatform() {}
	struct Z_CompiledInDeferFile_FID_UnrealEnginePP_Ruin_Run_RuinRunner_Source_RuinRunner_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealEnginePP_Ruin_Run_RuinRunner_Source_RuinRunner_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2160570411U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealEnginePP_Ruin_Run_RuinRunner_Source_RuinRunner_MovingPlatform_h_3806678579(TEXT("/Script/RuinRunner"),
		Z_CompiledInDeferFile_FID_UnrealEnginePP_Ruin_Run_RuinRunner_Source_RuinRunner_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealEnginePP_Ruin_Run_RuinRunner_Source_RuinRunner_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
